...
const NavBottom = () => {
  return (
    <div className="w-full flex px-3 py-1.5 flex-col items-start gap-2.5 rounded bg-[#4e515ed1]">
      <div className="flex items-center gap-3">
        <div
          className="flex p-1.5 items-start gap-2.5 rounded"
          style={{
        ...
        <div className="flex flex-col items-start gap-0.5">
          <p
            className="text-[#FFF] text-[13px] font-normal leading-4"
            style={{
              fontFamily: "Inter",
            }}
          >
          ...
          <p
            className="text-[#FFF] text-base font-medium leading-6"
            style={{
              fontFamily: "Inter",
            }}
          >
