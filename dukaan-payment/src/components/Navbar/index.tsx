const Navbar = () => {
  return (
    <div className="w-full flex py-3 px-8 items-center justify-between gap-4 border border-[#D9D9D9] bg-[#FFF]">
      <div className="w-full flex itemx-center gap-4">
        <div className="flex items-center gap-4">
          <p
            className="text-[#1A181E] text-[15px] font-normal leading-[22px]"
            style={{
              fontFamily: "Inter",
            }}
          >
        ...
        <div className="w-full flex items-center gap-1.5">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_49207_2522)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <defs>
              <clipPath id="clip0_49207_2522">
                <rect width="14" height="14" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <p
            className="w-full text-[#4D4D4D] text-xs font-normal leading-4"
            style={{
              fontFamily: "Inter",
            }}
          >
        ...
        <div className="w-full relative">
          <div className="w-full absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_49207_2526)">
                <path
          ...
          <input
            type="search"
            id="default-search"
            className="w-full  bg-[#F2F2F2] block w-full py-[9px] px-4 ps-8 text-sm text-gray-900  rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className="w-full flex justify-end items-start gap-2 ">
        <div className="flex items-start gap-3">
          ...
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_49207_2537)">
